...
# Using the same SECRET_KEY as login service for JWT compatibility
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'profiles.authentication.LoginServiceAuthentication',
...
LOGIN_SERVICE_URL = os.environ.get('LOGIN_SERVICE_URL', 'http://localhost:8000')
